...
freddie.setFreddiesRightMotorSpeed(50)

freddie.sendFreddieBackward(1)
freddie.sendFreddieForward(0.25)
freddie.turnFreddieLeft()
freddie.sendFreddieForward(0.5)
